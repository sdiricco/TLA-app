...
export const mockTournaments: MockTournament[] = [
  {
    ...
    phases: [{
      ...
      position: 1,
      name: 'Tabellone',
      description: 'Tabellone e incontri a eliminazione diretta della fase.',
      format: 'single_elimination',
      status: 'completed',
      group_count: 1,
      output_count: 1,
      ...
      groups: [],
      players: ['p-1', 'p-2', 'p-3', 'p-4', 'p-5', 'p-6', 'p-7', 'p-8'].map((playerId, index) => ({
        player_id: playerId,
        seed: index + 1,
        qualified: false,
      })),
  ...
  },
  {
    ...
    phases: [{
      ...
      position: 1,
      name: 'Girone unico',
      description: 'Calendario, risultati e classifica della fase.',
      format: 'round_robin',
      status: 'active',
      group_count: 1,
      output_count: 1,
      qualifiers_per_group: null,
      groups: [{ id: 'group-t2-a', phase_id: 'phase-t2-1', position: 1, name: 'Girone unico' }],
      players: ['p-1', 'p-3', 'p-5', 'p-7'].map((playerId, index) => ({
        player_id: playerId,
        group_id: 'group-t2-a',
        seed: index + 1,
        qualified: false,
